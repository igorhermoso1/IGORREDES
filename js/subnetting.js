...
function renderSubnettingPage() {
    ...
    container.innerHTML = `
        <div class="sim-tabs">
            <button class="sim-tab active" data-subtab="calc" onclick="switchSubTab(event, 'calc')">🧮 Calculadora</button>
            <button class="sim-tab" data-subtab="divide" onclick="switchSubTab(event, 'divide')">📐 Dividir red</button>
            <button class="sim-tab" data-subtab="practice" onclick="switchSubTab(event, 'practice')">🎯 Ejercicios</button>
