...
const PAGES = [
    ...
    'lab', 'progress', 'rewards', 'flashcards', 'floorplan', 'routerConfig'
];
...
function showPage(pageName, category = null) {
    ...
    try {
        ...
        } else if (pageName === 'floorplan') {
            renderFloorplanPage();
            if (typeof maybeShowTutorial === 'function') maybeShowTutorial('floorplan');
        } else if (pageName === 'routerConfig') {
            renderRouterConfigPage();
            if (typeof maybeShowTutorial === 'function') maybeShowTutorial('routerConfig');
        }
    } catch (e) {
